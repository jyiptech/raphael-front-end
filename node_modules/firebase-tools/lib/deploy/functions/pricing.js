...
function monthlyMinInstanceCost(functions) {
    ...
    let v1MemoryBill = usage[1][1].ram * exports.V1_RATES.memoryGb[1] + usage[1][2].ram * exports.V1_RATES.memoryGb[2];
    v1MemoryBill -= exports.V1_FREE_TIER.memoryGb * exports.V1_RATES.memoryGb[1];
    v1MemoryBill = Math.max(v1MemoryBill, 0);
    let v1CpuBill = usage[1][1].cpu * exports.V1_RATES.idleCpuGhz[1] + usage[1][2].cpu * exports.V1_RATES.idleCpuGhz[2];
    v1CpuBill -= exports.V1_FREE_TIER.cpuGhz * exports.V1_RATES.cpuGhz[1];
    v1CpuBill = Math.max(v1CpuBill, 0);
    let v2MemoryBill = usage[2][1].ram * exports.V2_RATES.memoryGb[1] + usage[2][2].ram * exports.V2_RATES.memoryGb[2];
    v2MemoryBill -= exports.V2_FREE_TIER.memoryGb * exports.V2_RATES.memoryGb[1];
    v2MemoryBill = Math.max(v2MemoryBill, 0);
    let v2CpuBill = usage[2][1].cpu * exports.V2_RATES.idleVCpu[1] + usage[2][2].cpu * exports.V2_RATES.idleVCpu[2];
